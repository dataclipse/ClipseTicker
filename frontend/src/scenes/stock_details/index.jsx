...
const Stocks = () => {
    ...
    const options = getCandlestickChartOptions(ticker, stockDetailsChartData, colors);

    const columns = [
        { field: "ticker_symbol", renderHeader: () => <Typography sx={{ fontWeight: 'bold' }}>{'Ticker'}</Typography>, flex: 1 },
        ...
        { field: "timestamp_end", renderHeader: () => <Typography sx={{ fontWeight: 'bold' }}>{'Date'}</Typography>, flex: 1, type: 'dateTime' },
    ];
