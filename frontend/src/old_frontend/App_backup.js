...
function App() {
  ...
  // Function for saving Changes to API Key
  ...
  // Function for formatting currency displayed with stocks
  const format_currency = (value) => {
    return `$${parseFloat(value).toFixed(2)}`;
  };

  // Function for sorting stocks by ticker symbol
  ...
  // Function for sorting stocks by metrics
  ...
  // Function for changing the sort direction icon
  ...
  // Function to format unix timestamps into more readable format
  ...
  // Function to handle deleting jobs
  ...
  // Function to handle fetching data for jobs
