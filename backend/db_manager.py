...
class DBManager:
    ...
    def update_job_status(self, job_name, scheduled_start_time, new_status):
        ...
        try:
            ...
            if result.rowcount > 0:
                ...
                print(
                    f"No job found with name '{job_name}' scheduled fo {scheduled_start_time}."
                )
    ...
    def delete_job(self, job_name, scheduled_start_time):
        ...
        try:
            ...
            if result.rowcount > 0:
                print(
                    f"Job '{job_name}' scheduled for {scheduled_start_time} deleted successfully."
                )
            else:
                print(
                    f"No job found with the name '{job_name}' scheduled for {scheduled_start_time}."
                )
    ...
    def insert_job(
        ...
        try:
            ...
            print(
                f"Job '{job_name}' scheduled for {scheduled_start_time} inserted successfully."
            )
